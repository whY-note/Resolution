...
编写代码，实现一阶逻辑归结反演，并实现以下两道题目

## 题目1

![image-20250324170014949](人工智能第二次实验.assets/image-20250324170014949.png)

## 题目2

![image-20250324170029932](人工智能第二次实验.assets/image-20250324170029932.png)
...
结合了最一般合一算法和命题逻辑的归结推理，可以得到一阶逻辑的归结推理

**算法流程：**

<img src="人工智能第二次实验.assets/6e75c4be684e77d5dd3f0add878cb0c-1742830006193-2.jpg" alt="6e75c4be684e77d5dd3f0add878cb0c"  />
...
12 R[1,4a]{x=john}= (C(john), S(john))
13 R[1,9a]{w=john}= (S(john), ~C(john))
14 R[2,5a]{u=rain}= (~L(mike,rain))
15 R[2,5b]= (~L(tony,u))
16 R[2,8b]{y=tony}= (~C(tony))
17 R[2,15]{u=rain} = []
```
...
4 ('On(tony,mike)',)
5 ('Green(tony)',)
6 R[2b,5]{xx=tony} = ('~On(tony,yy)', 'Green(yy)')
7 R[4,6a]{yy=mike} = ('Green(mike)',)
8 R[2b,7]{xx=mike} = ('Green(yy)', '~On(mike,yy)')
9 R[3,8a]{yy=john} = ('~On(mike,john)',)
10 R[1,9] = ()
```
...
[3] [归结原理、归结演绎推理-CSDN博客](https://blog.csdn.net/m0_51663233/article/details/134093476)
